	    ...
	    <div class="bg-white border-bottom box-shadow">
	      <div class="container d-flex flex-column flex-md-row align-items-center py-4">
		    ...
		    <nav class="my-2 my-md-0 mr-md-3">
		        ...
		        <a class="p-2 text-dark" href="login-sign-up.html">Login / Signup</a>
		    </nav>
	      </div>
	    </div>
	    	...
	    	<div class="form-row">
				<div id="search" class="col-7">
					<form action="/action_page.php">
					    <input class="form-control mr-sm-2" type="text" placeholder="Restaurant Name">
		  			</form>
				</div>
				<div class="col-1">
				...
				<div class="col-2 text-center">
					<input type="radio" id="bestmatch" name="sortingoption" value="bestmatch">
					<label for="bestmatch">Best Match</label><br>
					<input type="radio" id="rating" name="sortingoption" value="rating">
					<label for="radio">Rating</label>
				</div>
				<div class="col-2 text-center">
					<input type="radio" id="reviewcount" name="sortingoption" value="reviewcount">
					<label for="bestmatch">Review Count</label><br>
					<input type="radio" id="rating" name="sortingoption" value="rating">
					<label for="radio">Distance</label>	
				</div>
			</div>
			<br>
			<div class="form-row">
				<div class="col-4">
					<input class="form-control" type="number" value="latitude" id="latitude" placeholder="Latitude">
				</div>
				<div class="col-4">
					<input class="form-control" type="number" value="longitude" id="longitude" placeholder="Longitude">
				</div>
				<div class="col-4">
